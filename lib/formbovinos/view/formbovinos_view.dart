        ...
        return Stack(
          children: [
                  ...
                  children: [
                    ...
                    Obx(() {
                      return Padding(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                controller.currentPage.value == rangos.length - 1
                                    ? () async {
            ...
            if (controller.sendingData.value)
              Center(
                child: SpinKitCircle(
                  color: const Color.fromARGB(255, 3, 136, 244),
                  size: 100.0,
                ),
              ),
          ],
